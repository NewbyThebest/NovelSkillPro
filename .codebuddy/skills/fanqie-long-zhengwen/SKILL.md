...
description: "Draft Fanqie-style long webnovel chapters from outlines with pre-checks, retention calibration, anti-AI-expression review, and memory updates under 4-正文/. Use when the user asks for 正文, 写一章, 番茄正文, 审查正文, 审查章节, writing phase, or Fanqie chapter drafting."
---
...
## 目标
将大纲转化为适合番茄移动端阅读的高质量正文，按章纲分场景撰写，保证首屏抓力、单章推进、爽点兑现、章尾追读与去 AI 味，并更新角色状态、伏笔与进度。
...
- **动作**：
  ...
  - **结尾钩子**：确保章节末尾包含章纲中设计的悬念、危机、反转、新收益或关系爆点钩子。
